        ...
        <div class="container" style="margin-top: 10px;">
            <div class="row" style="border: 1px darkgrey solid; border-radius: 10px;width: 50%; margin: 0 auto; padding: 20px;" >
                <div class="col-sm-12">
                    ...
                    <form:form action="/admin/account/SaveOrUpdate" modelAttribute="ACCOUNT" method="post" enctype="multipart/form-data">
                       ...
                       <form:errors path="fullname" cssClass="error"></form:errors>
						...
						<div class="form-group">
                            <label>Photo</label>
                            <img alt=""  src="${ pageContext.request.contextPath }/uploads/${ACCOUNT.photo }" width="100px"><br>
                            <input type="file" class="form-control" value="${ACCOUNT.photo }" name="image"  placeholder="Enter photo"/>
                             <input type="text" class="form-control" value="${ACCOUNT.photo }" name="image"  placeholder="Enter photo"/>
                        ...
                        <a href="/admin/account/views" class="btn btn-primary">Display Account</a>
                    </form:form>
                </div>
            </div>
        </div>
