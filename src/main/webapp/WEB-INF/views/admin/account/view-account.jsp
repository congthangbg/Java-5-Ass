...
<body>
	...
	<div class="container">
		<h2>List Users1111</h2>
		<a href="/admin/account/register" class="btn btn-primary">Add Users</a>
			 <form class="form-inline my-2 my-lg-0" action="/admin/account/register/search" method="post">
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
		...
		<table class="table table-bordered">
			...
			<c:forEach items="${ACCOUNTS }" var="ac">
				<tr>
					<td align="center" width="20%"><img src="/uploads/${ac.photo }" width="40%"/></td>
					<td>${ac.username }</td>
					<td>${ac.password }</td>
					<td>${ac.fullname }</td>
					<td>${ac.email }</td>
					...
					<td><a class="btn btn-primary btn-sm" href="/admin/account/register/${ac.username }">Edit</a>
						| <a class="btn btn-danger btn-sm" href="/admin/account/views?btnDel=&username=${ac.username }">Del</a></td>
				</tr>
				</c:forEach>	
			</tbody>
		</table>
